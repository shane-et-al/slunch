...
# slunch = apiclient.discovery.build('kgsearch', 'v1',
#                                       developerKey=os.environ['API_KEY'])
# example_response = slunch.entities().search(query='lion', limit=1).execute()
